...
require_once "model/CategoryExtModel.class.php";
require_once "model/Category.class.php";
require_once "util/CategoryMessage.class.php";
require_once "util/CategoryFormValidation.class.php";

class CategoryExtController implements ControllerInterface {
    ...
    public function __construct() {
        ...
        $this->model=new CategoryExtModel();
    }
